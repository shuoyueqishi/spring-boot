...
public class MysqlTest {
    ...
    public void findPage(){
        ...
        for(User user : page.getContent()) {
            ...
            System.out.println(user.getName()+" "+user.getDeparment().getName()+" "+user.getRoles().get(0).getName());
        }
    }

    @Test
    public void test(){
        User user1 = userRepository.findByNameLike("x%");
        Assert.notNull(user1);

        User user2 = userRepository.readByName("xulitao");
